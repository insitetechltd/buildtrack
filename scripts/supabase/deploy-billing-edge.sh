...
bash "$ROOT/scripts/supabase/deploy-cancel-subscription.sh" --project-ref "$REF"
bash "$ROOT/scripts/supabase/deploy-billing-subscription-status.sh" --project-ref "$REF"
