...
- `WS-SUPABASE / M-SUPABASE-04a` **App reconnect shipped (`5d7b4e4`); live RO audit 0/4 FAIL (2026-08-10) — NOT Closed.** Evidence: `docs/superpowers/evidence/m-supabase-04a-publication-membership-redacted-20260810.md`. Remediation SQL (awaiting GO): `docs/superpowers/sql/20260810_msupabase04a_publication_add_tables.sql`. GO phrase: `you have GO for M-SUPABASE-04a publication ADD TABLE`.
...
- Current pipeline focus precedence: (1) **04a publication ADD TABLE GO** (unblock Realtime) → (2) optional 04d GO / 04c retention schedule → (3) 04b after ~2026-09-07. `S-UX-01P` is Pipeline but **deferred improvement** — not active focus.
