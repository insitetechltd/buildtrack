...
- Current pipeline focus: remaining `WS-UX / M-UX-01` redesign slices per `documentation/ROADMAP.md` (follow-up: groom WS-SUPABASE placeholder milestones M-SUPABASE-02a/b/c… into real roadmap rows at Orchestrator decision gate before promotion).
