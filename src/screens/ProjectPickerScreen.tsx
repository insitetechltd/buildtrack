  ...
  return (
    ...
    >
      ...
      <StandardHeader
        ...
        showBackButton={output.allowBack}
        onBackPress={output.allowBack ? onNavigateBack : undefined}
      ...
      <ScrollView testID="projectPicker-scroll" className="flex-1 px-6 py-4">
        <Text className={cn(
          ...
          {t.projects.yourProjects} ({output.projectItems.length})
        </Text>
        ...
        {output.projectItems.length === 0 ? (
          ...
          output.projectItems.map((project) => (
            <Pressable
              ...
              disabled={output.isProjectSwitching}
              className={cn(
                ...
                project.isSelected
                  ...
                  : "",
                output.isProjectSwitching && "opacity-50"
              )}
            >
