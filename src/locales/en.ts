...
export const en = {
  ...
  createTask: {
    ...
    chooserNewTask: "↓ Assign",
    reportIssueSubtitle: "Report a site observation or defect for review",
    myTaskSubtitle: "Direct personal task for yourself",
    headerReportSubtitle: "Report up",
    dialReportUp: "Report up",
    dialAssignWork: "Assign work",
    reportComingSoonTitle: "Report - Coming soon",
    reportComingSoonBody: "Reporting up to a higher company comes with multi-company projects.",
    submitReport: "Report",
    ...
    triagedToTask: "Triaged to Task",
    dismissIssue: "Dismiss Issue",
    dismissReason: "Dismissal Reason",
    replyToReport: "Reply",
    sendReply: "Send reply",
    replyMessage: "Reply",
    replyPlaceholder: "Write a reply to the reporter…",
    replySent: "Reply sent",
    replyFailed: "Failed to send reply",
    createTaskFromReport: "Create task",
    triageTaskHeader: "Create task",
    submitTriage: "Create task",
    resolveReport: "Resolve",
    resolveReportConfirmTitle: "Resolve without reply?",
  ...
  activity: {
    ...
    criticalThisWeek: "This Week's Critical Tasks",
    myQueue: "My Queue",
    ...
    photosCaptured: "{count} photos captured",
    savedToProject: "Saved to project",
    noRecentActivity: "No recent activity for the current project yet.",
    selectProjectForActivity: "Select a project to view recent activity.",
    savedDrafts: "Saved drafts",
    show: "Show",
    hide: "Hide",
    deleteDraftTitle: "Delete draft?",
    deleteDraftMessage: "This saved draft will be removed from this device.",
    unableToDeleteDraft: "Unable to delete draft",
    tryAgain: "Please try again.",
    // Stored English event templates → display localization
    createdBy: "Task created by {name}",
    acceptedBy: "Task accepted by {name}",
    assignedToBy: "Task assigned to {assignees} by {assigner}",
    assignmentUpdatedBy: "Task assignment updated by {name}",
    declinedByReason: "Task declined by {name}. Reason: {reason}",
    submittedForReviewBy: "Task submitted for review by {name}",
    completionAcceptedBy: "Task completion accepted by {name}",
    completionRejectedByReason: "Task completion rejected by {name}. Reason: {reason}",
    deletedBy: "Task deleted by {name}",
    cancelledBy: "Task cancelled by {name}",
    archivedBy: "Task archived by {name}",
    autoAcceptedBy: "Task auto-accepted by {name}",
    statusTaskSuffix: "{status} Task",
  },
