...
- Current pipeline focus: `WS-SUPABASE / M-SUPABASE-01` (immediate next: inspection-only 0 writes), and remaining `WS-UX / M-UX-01` redesign slices per `documentation/ROADMAP.md`.
