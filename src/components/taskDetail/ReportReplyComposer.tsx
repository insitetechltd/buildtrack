 ...
 *   hitSlop covers the overlay track on the compact chip;
 *   shouldCancelWhenOutside(false) keeps updates for the whole finger-down.
 *   Overlay is visual-only on the compact chip.
 */
