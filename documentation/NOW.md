...
**This session — CBP 264 in flight (2026-09-17):** Tip has scrubber release-retract + Tahoe local-build plugin vs already-submitted TF **263** → new local PROD IPA required. Gate 0 freeze Metro→PROD still **GO** (`fa5cff1` ⊂ HEAD). Branch `cursor/cbp-scrubber-tahoe-264-ddef`.
