...
- Current pipeline focus: `WS-QA / M-QA-03` (await S-UX-01I close), `WS-SUPABASE / M-SUPABASE-01`, and remaining `WS-UX / M-UX-01` redesign slices per `documentation/ROADMAP.md`.
