...
**This session — default branch rename (2026-09-17):** Live line is `main` (same SHA as former `master`). Pages source = `main` `/docs`. Old unrelated `main` parked at `archive/pre-2026-unrelated-main` — do not merge. GitHub Settings still need Human: default branch → `main`, Pages branch → `main` (agent token 403). Open PRs #7/#8 retarget to `main`. Local clones: `git fetch && git checkout main`.
