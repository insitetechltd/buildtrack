...
- Current pipeline focus precedence: (1) S-UX-01K Task Delegation Panel → (2) S-UX-01M location_on_site picker → (3) S-UX-01N Container Model (needs D3 containers DDL) → (4) parallel idle P1s: M-03a/03c/03d/03e → (5) parallel idle P2s: M-04a–d. Then remaining WS-UX / M-UX-01 redesign slices continue per pipeline.
