# App Review notes — Taskr 1.1.3 resubmit (build 257+)
...
Company plans and extra seats are also managed on the website (Stripe). We do not use Apple IAP for seats or company plans.
