...
- `WS-UX / S-UX-01Q` **Pipeline (P0 landed 2026-08-14; upload UX parked 2026-08-15)**: UI/UX consistency + nested layout — audit `docs/superpowers/analysis/2026-08-14-ui-ux-consistency-audit.md`. P0: orphans deleted, headers unified, PrimaryActionBar SafeArea contract, Dashboard/Tasks/Create/Photo flatten. **Parked upload UX (working tree):** in-app library Option A, Select Photos light edit/reorder, Create attachment dedupe + This week flag pill. Phase C + Option B gallery + draw spike deferred. Idle-parallel ok vs 04b.
