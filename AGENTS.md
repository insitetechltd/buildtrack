...
- `WS-UX / S-UX-01Q` **Pipeline (P0 landed 2026-08-14)**: UI/UX consistency + nested layout — audit `docs/superpowers/analysis/2026-08-14-ui-ux-consistency-audit.md`. P0: orphans deleted, headers unified, PrimaryActionBar SafeArea contract, Dashboard/Tasks/Create/Photo flatten. Phase C deferred. Idle-parallel ok vs 04b.
