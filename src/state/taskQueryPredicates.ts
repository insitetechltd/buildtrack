/**
 * Taskr-local copies of owner-task-query-contract.md named predicates.
 * Do not import this module from Edge or HQ — duplicate lives in
 * supabase/functions/owner-tenant-read/taskQueryPredicates.ts.
 */
