...
- `WS-PERF / M-PERF-03` **Pipeline (Phase B 2026-08-28)**: Device library thumb cache + warm prefetch + scroll-ahead decode. Device proof pending. Plan: `docs/superpowers/plans/2026-08-28-m-perf-03-library-picker-spike-plan.md`.
