...
- Current pipeline focus precedence: (1) **04b** after ~2026-09-07 (gated SQL; no column drops before then). **04e** cold archive is Pipeline deferred (later / idle-parallel after 04b is gated). `S-UX-01P` remains deferred UX hygiene — not active focus.
