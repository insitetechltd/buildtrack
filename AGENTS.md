...
- `WS-UX / S-UX-01Q` **Pipeline (P0 landed 2026-08-14; upload Phase 1+2 Draw closed 2026-08-15; Phase C deferred)**: UI/UX consistency + nested layout — audit `docs/superpowers/analysis/2026-08-14-ui-ux-consistency-audit.md`. P0: orphans deleted, headers unified, PrimaryActionBar SafeArea contract, Dashboard/Tasks/Create/Photo flatten. **Upload UX Phase 1+2 closed:** in-app library Option A, Select Photos light edit/reorder + Draw (Skia bake), Create attachment dedupe + This week flag pill. Phase C + Option B gallery + Phase 3 caption deferred. Idle-parallel ok vs 04b.
...
- Current pipeline focus precedence: (1) **04b** after ~2026-09-07 (gated SQL; no column drops before then). (2) **S-UX-01Q** Phase C / option-2 screens when scheduled. **04e** cold archive Pipeline deferred. `S-UX-01P` remains deferred UX hygiene.
